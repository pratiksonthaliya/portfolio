        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <h2 className="text-2xl font-display font-bold">
              {portfolioData.personal.firstName}<span className="text-primary">.</span>
            </h2>
            <p className="mt-4 text-muted-foreground max-w-md">
              {portfolioData.personal.footerDescription}
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#achievements" className="text-muted-foreground hover:text-foreground transition-colors">Achievements</a>
              </li>
              <li>
